...
public OnPluginStart()
{
	...
	g_hAmmoLimit = CreateConVar("sv_weaponmenu_ammo_limit", "0", "Sets the maximum amount of times ammo can be selected.", FCVAR_PLUGIN|FCVAR_SPONLY, true, 0.0);
	...
	RegConsoleCmd("sm_guns", Command_WeaponMenu);
...
{
	PrintToChat(client, "\x01[武器菜单] 输入 \x04!guns\x01 打开菜单", client);
}
...
Config_LoadWeapons() // Originally, this was from TwistedPanda's BuildWars : It helped alot!!
{
	...
	BuildPath(Path_SM, sPath, PLATFORM_MAX_PATH, "configs/weapon_menu_t.ini");
